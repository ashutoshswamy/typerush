// ponytail: 200-word curated common-English list, frequency-ordered.
// Tiers (200/1000/5000) slice+cycle this instead of shipping a real 5k dictionary.
// Swap in a real frequency corpus (e.g. wordfreq/COCA export) if tier fidelity matters later.
